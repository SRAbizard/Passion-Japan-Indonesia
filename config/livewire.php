...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Bumped from Livewire's 12MB default so we can accept large
        // assets (company-profile videos can easily hit several
        // hundred MB before compression). 1 GB matches the Filament
        // FileUpload->maxSize() on the SiteSettings page. PHP layer
        // is already ok — Laragon ships upload_max_filesize=2G,
        // post_max_size=2G.
        'rules' => ['required', 'file', 'max:1048576'], // 1024 MB
        'directory' => null,
        'middleware' => null,
        'preview_mimes' => [
        ...
        // Longer window — uploading 700MB on a 50 Mbit connection
        // takes ~2 minutes, the 5-minute default cut it close.
        'max_upload_time' => 30,
        'cleanup' => true,
    ],
