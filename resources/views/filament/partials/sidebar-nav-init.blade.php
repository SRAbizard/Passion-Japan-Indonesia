 ...
 *         localStorage.setItem('collapsedGroups', JSON.stringify(@js(...)))
 *     }
 *
 * It only seeds from PHP when the key is missing — never re-syncs. We
 * delete the key here so its init runs again with the current config.
 *
