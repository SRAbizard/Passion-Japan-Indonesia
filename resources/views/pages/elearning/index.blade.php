...
@section('content')
<x-jp.page-hero
    :eyebrow="__('E-Learning')"
    :title="__('Master Japanese on your own pace')"
    :subtitle="__('Bite-sized lessons, instructor-led courses, and quizzes that prepare you for life and work in Japan.')"
    :petals="10" />
